...
//mostly code came from foobar2000 SDK and have some modified.
...
const size_t UTF16_SIGN_SIZE = sizeof(UTF16_SIGN)/sizeof(UTF16_SIGN[0]);
const size_t UTF8_SIGN_SIZE = sizeof(UTF8_SIGN)/sizeof(UTF8_SIGN[0]);
